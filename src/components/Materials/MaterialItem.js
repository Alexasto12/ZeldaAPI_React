  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-4">
          <h3 className="text-blue-400 font-bold text-lg mb-1 group-hover:text-blue-300 transition-colors duration-300">{material.name}</h3>
        ...
        <Modal isOpen={showModal} onClose={handleCloseModal}>
          <div className="space-y-6">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-blue-400 mb-2">{material.name}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div style={{animationDelay: '0.1s'}} className="bg-gray-800/50 p-4 rounded-lg reveal-element">
                ...
                <p className="text-gray-300">{material.id_num}</p>
              </div>
              ...
              <div style={{animationDelay: '0.2s'}} className="bg-gray-800/50 p-4 rounded-lg reveal-element">
                ...
                <p className="text-gray-300">{material.category}</p>
              </div>
              ...
              <div style={{animationDelay: '0.4s'}} className="bg-gray-800/50 p-4 rounded-lg reveal-element">
                <p className="text-blue-400 font-medium mb-1">Corazones recuperados</p>
                <div className="flex items-center">
                  <p className="text-gray-300 mr-2">{material.hearts_recovered}</p>
              ...
              {material.common_locations && material.common_locations.length > 0 && (
              ...
              {material.cooking_effect && (
                <div style={{animationDelay: '0.6s'}} className="bg-gray-800/50 p-4 rounded-lg col-span-1 md:col-span-2 reveal-element">
                  <p className="text-blue-400 font-medium mb-1">Efecto de cocción</p>
                  <p className="text-yellow-300">{material.cooking_effect}</p>
                </div>
              )}
            </div>
